...
CKEDITOR.dialog.add('smiley',
    function(a){
        var b=a.config,c=b.smiley_images,d=8,e,f,
        g=function(k){
            ...
            p=a.document.createElement('img',{attributes:{src:n,_cke_saved_src:n,title:o,alt:o}});
            a.insertElement(p);
            f.hide();
        },
        ...
        for(e=0;e<c.length;e++){
            if(e%d===0)
                i.push('<tr>');
            i.push('<td class="cke_dark_background cke_hand cke_centered" style="vertical-align: middle;"><a href="javascript:void(0)" class="cke_smile" tabindex="-1" onkeydown="CKEDITOR.tools.callFunction( ',
                   h,
                   ', event, this );">','<img class="hand" title="',
                   b.smiley_descriptions[e],
                   '" cke_src="',
                   CKEDITOR.tools.htmlEncode(b.smiley_path+c[e]),
                   '" alt="',
                   b.smiley_descriptions[e],
                   '"',
                   ' src="',
        ...
        return {
            ...
            minWidth:270,
            minHeight:120,
            contents:[{id:'tab1',label:'',title:'',expand:true,padding:0,elements:[j]}],
